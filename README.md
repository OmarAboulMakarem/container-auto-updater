...
|---|---|---|
| `COMPOSE_PROJECT_NAME` | Parent dir of `COMPOSE_FILE` | Project name shown in email subjects. Set this explicitly — the default resolves to `compose` when using the recommended mount path. |
